...
//
//  gFromTable
//      This is the translation table for EBCDIC 500 to Unicode. This
//      table contains 256 entries. The entry for EBCDIC 500 byte x is the
//      Unicode translation of that byte.
//
//  gToTable
//  gToTableSz
//      This is the translation table for Unicode to EBCDIC 500. This one
...
//      field is the EBCDIC 500 code point to translate to.
// ---------------------------------------------------------------------------
static const ICF_uint32 gFromTable[256] =
{
	...
	0x00E4, /* 0x43 - LA170000 - a Diaeresis Small */
	...
	0x005B, /* 0x4A - SM060000 - Left Bracket */
	...
	0x00DF, /* 0x59 - LS610000 - Sharp s Small */
	0x005D, /* 0x5A - SM080000 - Right Bracket */
	...
	0x00C4, /* 0x63 - LA180000 - A Diaeresis Capital */
	...
	0x00A6, /* 0x6A - SM650000 - Vertical Line, Broken */
	...
	0x00A4, /* 0x9F - SC010000 - International Currency Symbol */
	0x00B5, /* 0xA0 - SM170000 - Micro Symbol */
	0x007E, /* 0xA1 - SD190000 - Tilde Accent */
	...
	0x00A7, /* 0xB5 - SM240000 - Section Symbol (USA)/Paragraph Symbol (Europe) */
	...
	0x007B, /* 0xC0 - SM110000 - Left Brace */
	...
	0x00D6, /* 0xEC - LO180000 - O Diaeresis Capital */
	...
	0x00DC, /* 0xFC - LU180000 - U Diaeresis Capital */
...
static const Transcoder256Table::Transcoder256TableRecord gToTable[] =
{
	...
	{0xFF3B, 0x4A}, /* SM060000 - Left Bracket */
	{0xFF3C, 0xE0}, /* SM070000 - Backslash */
	{0xFF3D, 0x5A}, /* SM080000 - Right Bracket */
	...
	{0xFF5B, 0xC0}, /* SM110000 - Left Brace */
	{0xFF5C, 0xBB}, /* SM130000 - Vertical Line/Logical OR */
	{0xFF5D, 0xD0}, /* SM140000 - Right Brace */
	{0xFF5E, 0xA1}, /* SD190000 - Tilde Accent */
	...
	{0xFFE4, 0x6A}, /* SM650000 - Vertical Line, Broken */
	{0xFFE5, 0xB2}  /* SC050000 - Yen Sign */
};
static const int gToTableSz = 357;
 

TranscoderIBM00500::TranscoderIBM00500() :
